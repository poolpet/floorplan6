...
>
> **⮕ NEXT SESSION (2026-06-22, DOM→AC: target instancji + story-guard WDROŻONE, auto-switch do nailingu live — branch `feat/sfh-open-plan-day-zone` ZMERGOWANY do `main` FF, NIE pushnięte; `main` 140 przed `origin/main`):**
