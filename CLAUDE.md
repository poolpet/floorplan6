# FloorPlan6 — orientacja dla Claude Code
...
**W każdej nowej sesji Claude Code NA START:**
...
| 8 | `CLAUDE.md` (ten plik) | Orientacja po dokumentach. | — |
...
## ZASADA Z CLAUDE CODE — PRZED PIERWSZĄ ZMIANĄ KODU
...
2. Claude przeczyta `docs/` w kolejności
